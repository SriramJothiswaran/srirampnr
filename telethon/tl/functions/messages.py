...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputUser, TypeInlineBotSwitchPM, TypeInputEncryptedFile, TypeInputChatPhoto, TypeInputMessage, TypeBool, TypeReportReason, TypeReplyMarkup, TypeInputDocument, TypeMessagesFilter, TypeInputGeoPoint, TypeInputEncryptedChat, TypeInputStickeredMedia, TypeInputDialogPeer, TypeMessageEntity, TypeSendMessageAction, TypeInputBotInlineMessageID, TypeInputPeer, TypeShippingOption, TypeInputStickerSet, TypeInputMedia, TypeInputBotInlineResult, TypeInputSingleMedia
...
class AddChatUserRequest(TLRequest):
    ...
    def resolve(self, client, utils):
        self.chat_id = client.get_peer_id(self.chat_id, add_mark=False)
...
class CreateChatRequest(TLRequest):
    ...
    def resolve(self, client, utils):
        ...
        for _x in self.users:
            _tmp.append(utils.get_input_user(client.get_input_entity(_x)))
...
class GetPeerDialogsRequest(TLRequest):
    ...
    def resolve(self, client, utils):
        ...
        for _x in self.peers:
            _tmp.append(utils.get_input_dialog(client.get_input_entity(_x)))
...
class SearchRequest(TLRequest):
    ...
    def resolve(self, client, utils):
        self.peer = utils.get_input_peer(client.get_input_entity(self.peer))
        if self.from_id:
            self.from_id = utils.get_input_user(client.get_input_entity(self.from_id))
