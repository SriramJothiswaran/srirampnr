...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelParticipantsFilter, TypeChannelBannedRights, TypeInputUser, TypeInputStickerSet, TypeChannelAdminRights, TypeInputChatPhoto, TypeChannelAdminLogEventsFilter, TypeBool, TypeInputChannel, TypeInputMessage
...
class GetChannelsRequest(TLRequest):
    ...
    def resolve(self, client, utils):
        _tmp = []
        for _x in self.id:
            _tmp.append(utils.get_input_channel(client.get_input_entity(_x)))
