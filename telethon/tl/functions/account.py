...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeAccountDaysTTL, TypeInputNotifyPeer, TypeInputPrivacyKey, TypeSecureValueType, TypeSecureCredentialsEncrypted, TypeInputPeerNotifySettings, TypeInputPrivacyRule, TypeBool, TypeInputPeer, TypeReportReason, TypeSecureValueHash, TypeInputSecureValue
...
class GetNotifySettingsRequest(TLRequest):
    ...
    def resolve(self, client, utils):
        self.peer = client._get_input_notify(self.peer)
