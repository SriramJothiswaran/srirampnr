...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeDocument, TypeHighScore, TypeStickerSet, TypeStickerPack, TypeMessage, TypeEncryptedFile, TypeUser, TypeChat, TypeInlineBotSwitchPM, TypeBotInlineResult, TypeFoundGif, TypeChatFull, TypeStickerSetCovered, TypeDialog
