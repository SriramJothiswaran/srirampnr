...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContactBlocked, TypePopularContact, TypeTopPeerCategoryPeers, TypeImportedContact, TypeContact, TypeContactLink, TypeChat, TypeUser, TypePeer
